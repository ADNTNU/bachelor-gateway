 ...
 * <p>
 * This interceptor performs the following steps for each incoming call (except for
 ...
 *   <li>Load user details using {@link CustomReactiveUserDetailsService} and ensure the account is enabled.</li>
 *   <li>Populate the gRPC {@link Context} with authentication metadata (company ID and scopes).</li>
