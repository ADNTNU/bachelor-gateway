...
import no.ntnu.gr10.bachelorgateway.auth.AuthProto;
 ...
 *
 * <p>Provides the <code>Authenticate</code> RPC method, which validates user credentials
...
public class AuthGrpcService extends AuthGrpc.AuthImplBase {
   ...
   *
   * <p>Takes an <code>AuthRequest</code> containing an ID and secret, authenticates the user,
