...
/**
 * Defines gRPC security-related context and metadata keys
 * used within the gateway interceptor and services.
 *
 * @author Daniel Neset
 * @version 03.05.2025
 */
public class SecurityContext {
  ...
  /**
   * Context key for storing and retrieving the list of
   * user authorities (scopes) extracted from the JWT.
   */
